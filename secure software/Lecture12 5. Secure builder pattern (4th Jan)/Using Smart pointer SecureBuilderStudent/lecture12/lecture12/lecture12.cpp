// lecture12.cpp : This file contains the 'main' function. Program execution begins and ends there.
//=================================================================================================
...
// this is to use smart pointer for class factory 
//==========

// here need to change calss factory to use smart pointer

//class TrustBaseQueryBuilderFactory
//{
//	shared_ptr<QueryBuilder>getBuilder(const Subject& currSubject)
//	{
//		if (currSubject.getTrustLevel() == TrustLevel::complete)
//			return make_shared<CompleteTrustQueryBuilder>();
//		else
//			if (currSubject.getTrustLevel() == TrustLevel::little)
//				return make_shared<LittleTrustQueryBuilder>();
//			else return make_shared<BannedTrustQueryBuilder>();
//		
//	}
//};
//==================================end of samrt class
...
int main(void)
{
	...
	// see the smart pointer here but off cause i must use smart pointer as mention above
	/*TrustBaseQueryBuilderFactory queryBuilderFactory;
	shared_ptr<QueryBuilder>builder = queryBuilderFactory.getBuilder(currSubject);
	Query query*/
	//========end of smart pointer is he

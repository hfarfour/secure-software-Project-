...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->textBox1->Text = L"Enter a 16 bit unsigned integer";
			...
			// maskedTextBox1
			// 
			this->maskedTextBox1->Location = System::Drawing::Point(65, 154);
			this->maskedTextBox1->Mask = L"00000";
			this->maskedTextBox1->Name = L"maskedTextBox1";
			this->maskedTextBox1->Size = System::Drawing::Size(149, 20);
			this->maskedTextBox1->TabIndex = 1;
			this->maskedTextBox1->ValidatingType = System::Int32::typeid;
			this->maskedTextBox1->MaskInputRejected += gcnew System::Windows::Forms::MaskInputRejectedEventHandler(this, &MainForm::maskedTextBox1_MaskInputRejected);
			// 
			// textBox2
			// 
			this->textBox2->Location = System::Drawing::Point(65, 206);
